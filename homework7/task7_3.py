...
class PublicTransport:
    ...
    @property
    def info(self):
        return f'Машина: {self.brand}, Мощность двигателя: {self._engine_power}, ' \
               f'Год выпуска: {self.year}, Цвет: {self.color}, Макс скорость: {self.max_speed}'
